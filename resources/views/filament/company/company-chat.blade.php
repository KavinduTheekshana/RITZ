<x-filament-panels::page>
    ...
    <div class="flex items-center space-x-2 p-2 bg-white dark:bg-gray-700 rounded border dark:border-gray-600">
        ...
        <div class="flex-1 min-w-0">
            <a href="{{ $message->file_url }}" target="_blank" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 truncate block">
                {{ $message->file_name }}
            </a>
                ...
                <div class="mt-1">
                    @if ($message->is_signed)
                        <span class="text-xs text-green-600 dark:text-green-400">
                            ...
                            Signed by {{ $message->signer_full_name }} on {{ $message->signed_at->format('M d, Y') }}
                        </span>
                        <a href="{{ $message->signed_file_url }}" target="_blank" class="block text-xs text-blue-600 hover:text-blue-800 mt-1">
        ...
        <a href="{{ $message->file_url }}" download="{{ $message->file_name }}" class="text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
