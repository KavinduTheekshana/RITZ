                            ...
                            ">
                                ...
                                @if ($message->hasFile())
                                    @if ($message->requires_signature && !$message->is_signed)
                                        ...
                                        <div class="mt-2 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                                            <div class="flex items-center justify-between">
                                    ...
                                    @else
                                        <!-- Regular file -->
                                        <div class="flex items-center space-x-3 p-3 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 mt-2">
